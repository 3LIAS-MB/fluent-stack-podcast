...
const getInfo = () => ({
    ...
    "fonts": {
        "normal": {
            "400": {
                "latin": "https://fonts.gstatic.com/s/cabinsketch/v19/QGYpz_kZZAGCONcK2A4bGOj8mNhN.woff2"
            },
            "700": {
                "latin": "https://fonts.gstatic.com/s/cabinsketch/v19/QGY2z_kZZAGCONcK2A4bGOj0I_1Y5tjz.woff2"
            }
        }
    }
});
