...
const getInfo = () => ({
    ...
    "fonts": {
        "normal": {
            "400": {
                "latin-ext": "https://fonts.gstatic.com/s/purplepurse/v21/qWctB66gv53iAp-Vfs4My6qCcRz-ijA.woff2",
                "latin": "https://fonts.gstatic.com/s/purplepurse/v21/qWctB66gv53iAp-Vfs4My6qCfxz-.woff2"
            }
        }
    }
});
