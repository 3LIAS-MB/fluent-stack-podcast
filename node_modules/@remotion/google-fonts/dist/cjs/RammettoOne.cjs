...
const getInfo = () => ({
    ...
    "fonts": {
        "normal": {
            "400": {
                "latin-ext": "https://fonts.gstatic.com/s/rammettoone/v15/LhWiMV3HOfMbMetJG3lQDppNO_Gduu8.woff2",
                "latin": "https://fonts.gstatic.com/s/rammettoone/v15/LhWiMV3HOfMbMetJG3lQDppNNfGd.woff2"
            }
        }
    }
});
