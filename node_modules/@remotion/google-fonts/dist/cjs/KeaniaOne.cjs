...
const getInfo = () => ({
    ...
    "version": "v21",
    "url": "https://fonts.googleapis.com/css2?family=Keania+One:ital,wght@0,400",
    "unicodeRanges": {
    ...
    "fonts": {
        "normal": {
            "400": {
                "latin-ext": "https://fonts.gstatic.com/s/keaniaone/v21/zOL54pXJk65E8pXardnu-c1kvthH.woff2",
                "latin": "https://fonts.gstatic.com/s/keaniaone/v21/zOL54pXJk65E8pXardnu-cNkvg.woff2"
            }
        }
    }
});
