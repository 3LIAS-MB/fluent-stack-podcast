...
const getInfo = () => ({
    ...
    "version": "v22",
    "url": "https://fonts.googleapis.com/css2?family=Hanalei+Fill:ital,wght@0,400",
    "unicodeRanges": {
    ...
    "fonts": {
        "normal": {
            "400": {
                "latin-ext": "https://fonts.gstatic.com/s/hanaleifill/v22/fC1mPYtObGbfyQznIaQzPQi8XgjAllk.woff2",
                "latin": "https://fonts.gstatic.com/s/hanaleifill/v22/fC1mPYtObGbfyQznIaQzPQi8UAjA.woff2"
            }
        }
    }
});
