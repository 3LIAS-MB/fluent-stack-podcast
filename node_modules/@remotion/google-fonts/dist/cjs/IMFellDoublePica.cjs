...
const getInfo = () => ({
    ...
    "fonts": {
        "italic": {
            "400": {
                "latin": "https://fonts.gstatic.com/s/imfelldoublepica/v14/3XF0EqMq_94s9PeKF7Fg4gOKINyMtZ8rf0aPU5ZE.woff2"
            }
        },
        "normal": {
            "400": {
                "latin": "https://fonts.gstatic.com/s/imfelldoublepica/v14/3XF2EqMq_94s9PeKF7Fg4gOKINyMtZ8rf0O_UQ.woff2"
            }
        }
    }
});
