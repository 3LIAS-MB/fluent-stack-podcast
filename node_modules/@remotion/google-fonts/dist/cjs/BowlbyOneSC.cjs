...
const getInfo = () => ({
    ...
    "fonts": {
        "normal": {
            "400": {
                "latin-ext": "https://fonts.gstatic.com/s/bowlbyonesc/v20/DtVlJxerQqQm37tzN3wMug9P_gH2ojhN.woff2",
                "latin": "https://fonts.gstatic.com/s/bowlbyonesc/v20/DtVlJxerQqQm37tzN3wMug9P_g_2og.woff2"
            }
        }
    }
});
