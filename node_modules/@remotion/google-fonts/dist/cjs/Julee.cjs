...
const getInfo = () => ({
    ...
    "importName": "Julee",
    "version": "v25",
    "url": "https://fonts.googleapis.com/css2?family=Julee:ital,wght@0,400",
    "unicodeRanges": {
    ...
    "fonts": {
        "normal": {
            "400": {
                "latin-ext": "https://fonts.gstatic.com/s/julee/v25/TuGfUVB3RpZPQ5ZCq9kDyQ.woff2",
                "latin": "https://fonts.gstatic.com/s/julee/v25/TuGfUVB3RpZPQ5ZMq9k.woff2"
            }
        }
    }
});
