...
const getInfo = () => ({
    ...
    "fonts": {
        "normal": {
            "400": {
                "telugu": "https://fonts.gstatic.com/s/ramaraja/v15/SlGTmQearpYAYG1CACI_oHFKaQ.woff2",
                "latin": "https://fonts.gstatic.com/s/ramaraja/v15/SlGTmQearpYAYG1CACIjoHE.woff2"
            }
        }
    }
});
