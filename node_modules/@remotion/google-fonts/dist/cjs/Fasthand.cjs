...
const getInfo = () => ({
    ...
    "fonts": {
        "normal": {
            "400": {
                "khmer": "https://fonts.gstatic.com/s/fasthand/v26/0yb9GDohyKTYn_ZEERkiaE0GrQ.woff2",
                "latin": "https://fonts.gstatic.com/s/fasthand/v26/0yb9GDohyKTYn_ZEERkpaE0.woff2"
            }
        }
    }
});
