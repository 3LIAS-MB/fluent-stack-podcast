...
const getInfo = () => ({
    ...
    "fonts": {
        "normal": {
            "400": {
                "vietnamese": "https://fonts.gstatic.com/s/gideonroman/v8/e3tmeuGrVOys8sxzZgWlmXoQc0nXkvc.woff2",
                "latin-ext": "https://fonts.gstatic.com/s/gideonroman/v8/e3tmeuGrVOys8sxzZgWlmXoQcknXkvc.woff2",
                "latin": "https://fonts.gstatic.com/s/gideonroman/v8/e3tmeuGrVOys8sxzZgWlmXoQfEnX.woff2"
            }
        }
    }
});
