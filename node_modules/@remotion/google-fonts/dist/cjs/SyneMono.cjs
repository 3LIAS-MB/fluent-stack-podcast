...
const getInfo = () => ({
    ...
    "fonts": {
        "normal": {
            "400": {
                "latin-ext": "https://fonts.gstatic.com/s/synemono/v15/K2FzfZNHj_FHBmRbFvHDK6qlPys.woff2",
                "latin": "https://fonts.gstatic.com/s/synemono/v15/K2FzfZNHj_FHBmRbFvHDJaql.woff2"
            }
        }
    }
});
