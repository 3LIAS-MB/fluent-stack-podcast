...
const getInfo = () => ({
    ...
    "version": "v26",
    "url": "https://fonts.googleapis.com/css2?family=Almendra+Display:ital,wght@0,400",
    "unicodeRanges": {
    ...
    "fonts": {
        "normal": {
            "400": {
                "latin-ext": "https://fonts.gstatic.com/s/almendradisplay/v26/0FlPVOGWl1Sb4O3tETtADHRRlZhzbSbUTher.woff2",
                "latin": "https://fonts.gstatic.com/s/almendradisplay/v26/0FlPVOGWl1Sb4O3tETtADHRRlZhzbSjUTg.woff2"
            }
        }
    }
});
