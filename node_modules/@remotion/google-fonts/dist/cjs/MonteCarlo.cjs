...
const getInfo = () => ({
    ...
    "fonts": {
        "normal": {
            "400": {
                "vietnamese": "https://fonts.gstatic.com/s/montecarlo/v8/buEzpo6-f9X01GadLA0G4CIf_exL.woff2",
                "latin-ext": "https://fonts.gstatic.com/s/montecarlo/v8/buEzpo6-f9X01GadLA0G4CMf_exL.woff2",
                "latin": "https://fonts.gstatic.com/s/montecarlo/v8/buEzpo6-f9X01GadLA0G4C0f_Q.woff2"
            }
        }
    }
});
