...
const getInfo = () => ({
    ...
    "fonts": {
        "normal": {
            "400": {
                "latin-ext": "https://fonts.gstatic.com/s/dynalight/v18/1Ptsg8LOU_aOmQvTsF44Q4FqPfE.woff2",
                "latin": "https://fonts.gstatic.com/s/dynalight/v18/1Ptsg8LOU_aOmQvTsF44TYFq.woff2"
            }
        }
    }
});
