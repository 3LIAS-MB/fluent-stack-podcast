...
const getInfo = () => ({
    ...
    "fonts": {
        "normal": {
            "400": {
                "latin-ext": "https://fonts.gstatic.com/s/butcherman/v24/2EbiL-thF0loflXUBOdb5zy5qs5u.woff2",
                "latin": "https://fonts.gstatic.com/s/butcherman/v24/2EbiL-thF0loflXUBOdb5zK5qg.woff2"
            }
        }
    }
});
