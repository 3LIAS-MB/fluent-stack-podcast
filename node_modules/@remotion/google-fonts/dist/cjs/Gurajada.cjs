...
const getInfo = () => ({
    ...
    "fonts": {
        "normal": {
            "400": {
                "telugu": "https://fonts.gstatic.com/s/gurajada/v15/FwZY7-Qx308m-l-0Ke6b6MmTpA.woff2",
                "latin": "https://fonts.gstatic.com/s/gurajada/v15/FwZY7-Qx308m-l-0Ke6H6Mk.woff2"
            }
        }
    }
});
