...
const getInfo = () => ({
    ...
    "fonts": {
        "normal": {
            "400": {
                "devanagari": "https://fonts.gstatic.com/s/asar/v22/sZlLdRyI6TBIbkAaDYlT.woff2",
                "latin-ext": "https://fonts.gstatic.com/s/asar/v22/sZlLdRyI6TBIbk8aDYlT.woff2",
                "latin": "https://fonts.gstatic.com/s/asar/v22/sZlLdRyI6TBIbkEaDQ.woff2"
            }
        }
    }
});
