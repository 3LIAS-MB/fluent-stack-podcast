...
const getInfo = () => ({
    ...
    "version": "v16",
    "url": "https://fonts.googleapis.com/css2?family=Headland+One:ital,wght@0,400",
    "unicodeRanges": {
    ...
    "fonts": {
        "normal": {
            "400": {
                "latin-ext": "https://fonts.gstatic.com/s/headlandone/v16/yYLu0hHR2vKnp89Tk1TCq3TB2fNSSZ0.woff2",
                "latin": "https://fonts.gstatic.com/s/headlandone/v16/yYLu0hHR2vKnp89Tk1TCq3TB1_NS.woff2"
            }
        }
    }
});
