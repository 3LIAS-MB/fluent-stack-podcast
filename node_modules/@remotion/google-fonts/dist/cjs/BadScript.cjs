...
const getInfo = () => ({
    ...
    "fonts": {
        "normal": {
            "400": {
                "cyrillic": "https://fonts.gstatic.com/s/badscript/v16/6NUT8F6PJgbFWQn47_x7pO8kzO1A.woff2",
                "latin": "https://fonts.gstatic.com/s/badscript/v16/6NUT8F6PJgbFWQn47_x7pOskzA.woff2"
            }
        }
    }
});
