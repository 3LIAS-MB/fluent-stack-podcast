...
const getInfo = () => ({
    ...
    "fonts": {
        "normal": {
            "400": {
                "ahom": "https://fonts.gstatic.com/s/notoserifahom/v19/FeVIS0hfp6cprmEUffAW_fUL_ANOY80PMWGp.woff2",
                "latin-ext": "https://fonts.gstatic.com/s/notoserifahom/v19/FeVIS0hfp6cprmEUffAW_fUL_ANOy-wqDFg.woff2",
                "latin": "https://fonts.gstatic.com/s/notoserifahom/v19/FeVIS0hfp6cprmEUffAW_fUL_ANOxewq.woff2"
            }
        }
    }
});
