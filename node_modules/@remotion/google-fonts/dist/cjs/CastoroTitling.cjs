...
const getInfo = () => ({
    ...
    "version": "v3",
    "url": "https://fonts.googleapis.com/css2?family=Castoro+Titling:ital,wght@0,400",
    "unicodeRanges": {
    ...
    "fonts": {
        "normal": {
            "400": {
                "latin-ext": "https://fonts.gstatic.com/s/castorotitling/v3/buEupouwccj03leTfjUAhEZWlrNaaw0lSo8.woff2",
                "latin": "https://fonts.gstatic.com/s/castorotitling/v3/buEupouwccj03leTfjUAhEZWlrNaZQ0l.woff2"
            }
        }
    }
});
