...
const getInfo = () => ({
    ...
    "version": "v17",
    "url": "https://fonts.googleapis.com/css2?family=Limelight:ital,wght@0,400",
    "unicodeRanges": {
    ...
    "fonts": {
        "normal": {
            "400": {
                "latin-ext": "https://fonts.gstatic.com/s/limelight/v17/XLYkIZL7aopJVbZJHDuoNOlHnnY.woff2",
                "latin": "https://fonts.gstatic.com/s/limelight/v17/XLYkIZL7aopJVbZJHDuoOulH.woff2"
            }
        }
    }
});
