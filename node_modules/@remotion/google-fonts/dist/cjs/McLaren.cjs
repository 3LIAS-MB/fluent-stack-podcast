...
const getInfo = () => ({
    ...
    "importName": "McLaren",
    "version": "v14",
    "url": "https://fonts.googleapis.com/css2?family=McLaren:ital,wght@0,400",
    "unicodeRanges": {
    ...
    "fonts": {
        "normal": {
            "400": {
                "latin-ext": "https://fonts.gstatic.com/s/mclaren/v14/2EbnL-ZuAXFqZFXIeY8V8g2Y.woff2",
                "latin": "https://fonts.gstatic.com/s/mclaren/v14/2EbnL-ZuAXFqZFXIeYEV8g.woff2"
            }
        }
    }
});
