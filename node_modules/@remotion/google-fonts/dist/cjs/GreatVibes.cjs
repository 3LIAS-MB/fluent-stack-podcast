...
const getInfo = () => ({
    ...
    "fonts": {
        "normal": {
            "400": {
                "vietnamese": "https://fonts.gstatic.com/s/greatvibes/v15/RWmMoKWR9v4ksMfaWd_JN9XKiaQ6DQ.woff2",
                "latin-ext": "https://fonts.gstatic.com/s/greatvibes/v15/RWmMoKWR9v4ksMfaWd_JN9XLiaQ6DQ.woff2",
                "latin": "https://fonts.gstatic.com/s/greatvibes/v15/RWmMoKWR9v4ksMfaWd_JN9XFiaQ.woff2"
            }
        }
    }
});
