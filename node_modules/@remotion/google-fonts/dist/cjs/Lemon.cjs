...
const getInfo = () => ({
    ...
    "importName": "Lemon",
    "version": "v15",
    "url": "https://fonts.googleapis.com/css2?family=Lemon:ital,wght@0,400",
    "unicodeRanges": {
    ...
    "fonts": {
        "normal": {
            "400": {
                "latin-ext": "https://fonts.gstatic.com/s/lemon/v15/HI_EiYEVKqRMq3jIQ5TwQw.woff2",
                "latin": "https://fonts.gstatic.com/s/lemon/v15/HI_EiYEVKqRMq3jGQ5Q.woff2"
            }
        }
    }
});
