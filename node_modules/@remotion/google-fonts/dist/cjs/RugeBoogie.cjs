...
const getInfo = () => ({
    ...
    "fonts": {
        "normal": {
            "400": {
                "vietnamese": "https://fonts.gstatic.com/s/rugeboogie/v25/JIA3UVFwbHRF_GIWSMhKNSOqNTQfeQ.woff2",
                "latin-ext": "https://fonts.gstatic.com/s/rugeboogie/v25/JIA3UVFwbHRF_GIWSMhKNSOrNTQfeQ.woff2",
                "latin": "https://fonts.gstatic.com/s/rugeboogie/v25/JIA3UVFwbHRF_GIWSMhKNSOlNTQ.woff2"
            }
        }
    }
});
