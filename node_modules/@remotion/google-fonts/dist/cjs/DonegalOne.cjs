...
const getInfo = () => ({
    ...
    "version": "v21",
    "url": "https://fonts.googleapis.com/css2?family=Donegal+One:ital,wght@0,400",
    "unicodeRanges": {
    ...
    "fonts": {
        "normal": {
            "400": {
                "latin-ext": "https://fonts.gstatic.com/s/donegalone/v21/m8JWjfRYea-ZnFz6fsK9FaRMTm663A.woff2",
                "latin": "https://fonts.gstatic.com/s/donegalone/v21/m8JWjfRYea-ZnFz6fsK9FaRCTm4.woff2"
            }
        }
    }
});
