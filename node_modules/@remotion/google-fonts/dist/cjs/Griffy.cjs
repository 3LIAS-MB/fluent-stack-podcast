...
const getInfo = () => ({
    ...
    "importName": "Griffy",
    "version": "v22",
    "url": "https://fonts.googleapis.com/css2?family=Griffy:ital,wght@0,400",
    "unicodeRanges": {
    ...
    "fonts": {
        "normal": {
            "400": {
                "latin-ext": "https://fonts.gstatic.com/s/griffy/v22/FwZa7-ox2FQh9kfAQd6F8M0.woff2",
                "latin": "https://fonts.gstatic.com/s/griffy/v22/FwZa7-ox2FQh9kfAT96F.woff2"
            }
        }
    }
});
