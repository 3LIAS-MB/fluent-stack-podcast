...
const getInfo = () => ({
    ...
    "importName": "Alkalami",
    "version": "v7",
    "url": "https://fonts.googleapis.com/css2?family=Alkalami:ital,wght@0,400",
    "unicodeRanges": {
    ...
    "fonts": {
        "normal": {
            "400": {
                "arabic": "https://fonts.gstatic.com/s/alkalami/v7/zOL_4pfDmqRL95WXi6eJycF8ug.woff2",
                "latin-ext": "https://fonts.gstatic.com/s/alkalami/v7/zOL_4pfDmqRL95WXi6eCycF8ug.woff2",
                "latin": "https://fonts.gstatic.com/s/alkalami/v7/zOL_4pfDmqRL95WXi6eMycE.woff2"
            }
        }
    }
});
