...
const getInfo = () => ({
    ...
    "fonts": {
        "normal": {
            "400": {
                "vietnamese": "https://fonts.gstatic.com/s/voltaire/v18/1Pttg8PcRfSblAvGvTogaqRXBA.woff2",
                "latin-ext": "https://fonts.gstatic.com/s/voltaire/v18/1Pttg8PcRfSblAvGvTohaqRXBA.woff2",
                "latin": "https://fonts.gstatic.com/s/voltaire/v18/1Pttg8PcRfSblAvGvTovaqQ.woff2"
            }
        }
    }
});
