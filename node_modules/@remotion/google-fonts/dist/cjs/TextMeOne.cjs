...
const getInfo = () => ({
    ...
    "version": "v21",
    "url": "https://fonts.googleapis.com/css2?family=Text+Me+One:ital,wght@0,400",
    "unicodeRanges": {
    ...
    "fonts": {
        "normal": {
            "400": {
                "latin-ext": "https://fonts.gstatic.com/s/textmeone/v21/i7dOIFdlayuLUvgoFvHQFVZVYFeCGg.woff2",
                "latin": "https://fonts.gstatic.com/s/textmeone/v21/i7dOIFdlayuLUvgoFvHQFVZbYFc.woff2"
            }
        }
    }
});
