...
const getInfo = () => ({
    ...
    "fonts": {
        "normal": {
            "400": {
                "telugu": "https://fonts.gstatic.com/s/ramabhadra/v15/EYq2maBOwqRW9P1SQ83LSghMXquW.woff2",
                "latin": "https://fonts.gstatic.com/s/ramabhadra/v15/EYq2maBOwqRW9P1SQ83LShRMXg.woff2"
            }
        }
    }
});
