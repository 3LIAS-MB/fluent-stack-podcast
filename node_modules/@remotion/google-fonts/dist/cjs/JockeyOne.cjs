...
const getInfo = () => ({
    ...
    "fonts": {
        "normal": {
            "400": {
                "latin-ext": "https://fonts.gstatic.com/s/jockeyone/v16/HTxpL2g2KjCFj4x8WI6AnI_xHLOk.woff2",
                "latin": "https://fonts.gstatic.com/s/jockeyone/v16/HTxpL2g2KjCFj4x8WI6AnIHxHA.woff2"
            }
        }
    }
});
