...
const getInfo = () => ({
    ...
    "version": "v15",
    "url": "https://fonts.googleapis.com/css2?family=Freckle+Face:ital,wght@0,400",
    "unicodeRanges": {
    ...
    "fonts": {
        "normal": {
            "400": {
                "latin-ext": "https://fonts.gstatic.com/s/freckleface/v15/AMOWz4SXrmKHCvXTohxY-YIEWli389k.woff2",
                "latin": "https://fonts.gstatic.com/s/freckleface/v15/AMOWz4SXrmKHCvXTohxY-YIEVFi3.woff2"
            }
        }
    }
});
