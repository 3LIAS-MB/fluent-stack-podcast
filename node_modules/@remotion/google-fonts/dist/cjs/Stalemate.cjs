...
const getInfo = () => ({
    ...
    "fonts": {
        "normal": {
            "400": {
                "latin-ext": "https://fonts.gstatic.com/s/stalemate/v20/taiIGmZ_EJq97-UfkZRZs66twZQ.woff2",
                "latin": "https://fonts.gstatic.com/s/stalemate/v20/taiIGmZ_EJq97-UfkZRZva6t.woff2"
            }
        }
    }
});
