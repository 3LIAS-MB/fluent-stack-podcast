...
const getInfo = () => ({
    ...
    "fonts": {
        "italic": {
            "400": {
                "latin": "https://fonts.gstatic.com/s/imfellgreatprimer/v21/bx6UNwSJtayYxOkbYFsT6hMsLzX7u85rJrrVhjkfTQ.woff2"
            }
        },
        "normal": {
            "400": {
                "latin": "https://fonts.gstatic.com/s/imfellgreatprimer/v21/bx6aNwSJtayYxOkbYFsT6hMsLzX7u85rJrrQtjs.woff2"
            }
        }
    }
});
