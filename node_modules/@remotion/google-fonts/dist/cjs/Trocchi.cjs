...
const getInfo = () => ({
    ...
    "importName": "Trocchi",
    "version": "v15",
    "url": "https://fonts.googleapis.com/css2?family=Trocchi:ital,wght@0,400",
    "unicodeRanges": {
    ...
    "fonts": {
        "normal": {
            "400": {
                "latin-ext": "https://fonts.gstatic.com/s/trocchi/v15/qWcqB6WkuIDxDZLcPrJevfeT.woff2",
                "latin": "https://fonts.gstatic.com/s/trocchi/v15/qWcqB6WkuIDxDZLcPrxevQ.woff2"
            }
        }
    }
});
