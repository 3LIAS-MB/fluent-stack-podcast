...
const getInfo = () => ({
    ...
    "fonts": {
        "normal": {
            "400": {
                "latin-ext": "https://fonts.gstatic.com/s/amarante/v23/xMQXuF1KTa6EvGx9bp--AXvwmA.woff2",
                "latin": "https://fonts.gstatic.com/s/amarante/v23/xMQXuF1KTa6EvGx9bp-wAXs.woff2"
            }
        }
    }
});
