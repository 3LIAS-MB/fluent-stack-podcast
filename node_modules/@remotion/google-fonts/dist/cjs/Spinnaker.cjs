...
const getInfo = () => ({
    ...
    "fonts": {
        "normal": {
            "400": {
                "latin-ext": "https://fonts.gstatic.com/s/spinnaker/v17/w8gYH2oyX-I0_rvR6HmX1XYKmOo.woff2",
                "latin": "https://fonts.gstatic.com/s/spinnaker/v17/w8gYH2oyX-I0_rvR6HmX23YK.woff2"
            }
        }
    }
});
