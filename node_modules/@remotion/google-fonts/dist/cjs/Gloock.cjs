...
const getInfo = () => ({
    ...
    "fonts": {
        "normal": {
            "400": {
                "cyrillic-ext": "https://fonts.gstatic.com/s/gloock/v2/Iurb6YFw84WUY4NJhRakNrc.woff2",
                "latin-ext": "https://fonts.gstatic.com/s/gloock/v2/Iurb6YFw84WUY4NJhhakNrc.woff2",
                "latin": "https://fonts.gstatic.com/s/gloock/v2/Iurb6YFw84WUY4NJiBak.woff2"
            }
        }
    }
});
