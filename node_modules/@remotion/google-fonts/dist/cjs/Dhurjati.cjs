...
const getInfo = () => ({
    ...
    "fonts": {
        "normal": {
            "400": {
                "telugu": "https://fonts.gstatic.com/s/dhurjati/v20/_6_8ED3gSeatXfFiFU3pQqUduQ.woff2",
                "latin": "https://fonts.gstatic.com/s/dhurjati/v20/_6_8ED3gSeatXfFiFU31QqU.woff2"
            }
        }
    }
});
