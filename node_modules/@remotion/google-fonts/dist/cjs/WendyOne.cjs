...
const getInfo = () => ({
    ...
    "fonts": {
        "normal": {
            "400": {
                "latin-ext": "https://fonts.gstatic.com/s/wendyone/v15/2sDcZGJOipXfgfXV5wgzZmW5O7w.woff2",
                "latin": "https://fonts.gstatic.com/s/wendyone/v15/2sDcZGJOipXfgfXV5wgzaGW5.woff2"
            }
        }
    }
});
