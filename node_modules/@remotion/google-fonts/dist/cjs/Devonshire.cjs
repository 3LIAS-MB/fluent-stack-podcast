...
const getInfo = () => ({
    ...
    "version": "v22",
    "url": "https://fonts.googleapis.com/css2?family=Devonshire:ital,wght@0,400",
    "unicodeRanges": {
    ...
    "fonts": {
        "normal": {
            "400": {
                "latin-ext": "https://fonts.gstatic.com/s/devonshire/v22/46kqlbDwWirWr4gtBD2Bb0xg0mlY.woff2",
                "latin": "https://fonts.gstatic.com/s/devonshire/v22/46kqlbDwWirWr4gtBD2Bb0Jg0g.woff2"
            }
        }
    }
});
