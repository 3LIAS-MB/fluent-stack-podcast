...
const getInfo = () => ({
    ...
    "fonts": {
        "normal": {
            "400": {
                "latin-ext": "https://fonts.gstatic.com/s/elsie/v13/BCanqZABrez54xYn_MhweA.woff2",
                "latin": "https://fonts.gstatic.com/s/elsie/v13/BCanqZABrez54xYp_Mg.woff2"
            },
            "900": {
                "latin-ext": "https://fonts.gstatic.com/s/elsie/v13/BCaqqZABrez54x6q291BWaUuXQ.woff2",
                "latin": "https://fonts.gstatic.com/s/elsie/v13/BCaqqZABrez54x6q291PWaU.woff2"
            }
        }
    }
});
