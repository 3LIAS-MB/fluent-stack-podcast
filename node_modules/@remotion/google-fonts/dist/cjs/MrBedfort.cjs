...
const getInfo = () => ({
    ...
    "version": "v22",
    "url": "https://fonts.googleapis.com/css2?family=Mr+Bedfort:ital,wght@0,400",
    "unicodeRanges": {
    ...
    "fonts": {
        "normal": {
            "400": {
                "latin-ext": "https://fonts.gstatic.com/s/mrbedfort/v22/MQpR-WCtNZSWAdTMwBicpiO-XKe_.woff2",
                "latin": "https://fonts.gstatic.com/s/mrbedfort/v22/MQpR-WCtNZSWAdTMwBicpi2-XA.woff2"
            }
        }
    }
});
