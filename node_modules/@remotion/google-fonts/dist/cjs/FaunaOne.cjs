...
const getInfo = () => ({
    ...
    "importName": "FaunaOne",
    "version": "v15",
    "url": "https://fonts.googleapis.com/css2?family=Fauna+One:ital,wght@0,400",
    "unicodeRanges": {
    ...
    "fonts": {
        "normal": {
            "400": {
                "latin-ext": "https://fonts.gstatic.com/s/faunaone/v15/wlpzgwTPBVpjpCuwkuEB0EZKUCk.woff2",
                "latin": "https://fonts.gstatic.com/s/faunaone/v15/wlpzgwTPBVpjpCuwkuEB3kZK.woff2"
            }
        }
    }
});
