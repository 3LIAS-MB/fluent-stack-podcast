...
const getInfo = () => ({
    ...
    "importName": "Felipa",
    "version": "v20",
    "url": "https://fonts.googleapis.com/css2?family=Felipa:ital,wght@0,400",
    "unicodeRanges": {
    ...
    "fonts": {
        "normal": {
            "400": {
                "latin-ext": "https://fonts.gstatic.com/s/felipa/v20/FwZa7-owz1Eu4F_AQd6F8M0.woff2",
                "latin": "https://fonts.gstatic.com/s/felipa/v20/FwZa7-owz1Eu4F_AT96F.woff2"
            }
        }
    }
});
