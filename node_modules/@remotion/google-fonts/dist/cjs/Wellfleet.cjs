...
const getInfo = () => ({
    ...
    "fonts": {
        "normal": {
            "400": {
                "latin-ext": "https://fonts.gstatic.com/s/wellfleet/v20/nuF7D_LfQJb3VYgX6eyj6myKPhM.woff2",
                "latin": "https://fonts.gstatic.com/s/wellfleet/v20/nuF7D_LfQJb3VYgX6eyj5GyK.woff2"
            }
        }
    }
});
