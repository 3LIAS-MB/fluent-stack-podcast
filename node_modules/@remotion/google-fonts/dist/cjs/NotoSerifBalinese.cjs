...
const getInfo = () => ({
    ...
    "fonts": {
        "normal": {
            "400": {
                "balinese": "https://fonts.gstatic.com/s/notoserifbalinese/v18/QdVKSS0-JginysQSRvuCmUMB_wVeQAxXdZgDdyap.woff2",
                "latin-ext": "https://fonts.gstatic.com/s/notoserifbalinese/v18/QdVKSS0-JginysQSRvuCmUMB_wVeQAxXdbEDdyap.woff2",
                "latin": "https://fonts.gstatic.com/s/notoserifbalinese/v18/QdVKSS0-JginysQSRvuCmUMB_wVeQAxXdb8Ddw.woff2"
            }
        }
    }
});
