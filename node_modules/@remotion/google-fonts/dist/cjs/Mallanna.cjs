...
const getInfo = () => ({
    ...
    "fonts": {
        "normal": {
            "400": {
                "telugu": "https://fonts.gstatic.com/s/mallanna/v13/hv-Vlzx-KEQb84YaDFwoGTVAVg.woff2",
                "latin": "https://fonts.gstatic.com/s/mallanna/v13/hv-Vlzx-KEQb84YaDFw0GTU.woff2"
            }
        }
    }
});
