...
const getInfo = () => ({
    ...
    "version": "v14",
    "url": "https://fonts.googleapis.com/css2?family=Righteous:ital,wght@0,400",
    "unicodeRanges": {
    ...
    "fonts": {
        "normal": {
            "400": {
                "latin-ext": "https://fonts.gstatic.com/s/righteous/v14/1cXxaUPXBpj2rGoU7C9WhnGFucE.woff2",
                "latin": "https://fonts.gstatic.com/s/righteous/v14/1cXxaUPXBpj2rGoU7C9WiHGF.woff2"
            }
        }
    }
});
