...
const getInfo = () => ({
    ...
    "fonts": {
        "normal": {
            "400": {
                "telugu": "https://fonts.gstatic.com/s/suravaram/v21/_gP61R_usiY7SCym4xIwkGS0cv8.woff2",
                "latin": "https://fonts.gstatic.com/s/suravaram/v21/_gP61R_usiY7SCym4xIwjGS0.woff2"
            }
        }
    }
});
