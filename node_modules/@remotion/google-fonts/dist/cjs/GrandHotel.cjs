...
const getInfo = () => ({
    ...
    "fonts": {
        "normal": {
            "400": {
                "latin-ext": "https://fonts.gstatic.com/s/grandhotel/v14/7Au7p_IgjDKdCRWuR1azplQEGFw-0g.woff2",
                "latin": "https://fonts.gstatic.com/s/grandhotel/v14/7Au7p_IgjDKdCRWuR1azplQKGFw.woff2"
            }
        }
    }
});
