...
const getInfo = () => ({
    ...
    "fonts": {
        "italic": {
            "400": {
                "latin-ext": "https://fonts.gstatic.com/s/fondamento/v17/4UaFrEJGsxNmFTPDnkaJ96_Z67txEwI.woff2",
                "latin": "https://fonts.gstatic.com/s/fondamento/v17/4UaFrEJGsxNmFTPDnkaJ96_Z5btx.woff2"
            }
        },
        "normal": {
            "400": {
                "latin-ext": "https://fonts.gstatic.com/s/fondamento/v17/4UaHrEJGsxNmFTPDnkaJ96Tp56N1.woff2",
                "latin": "https://fonts.gstatic.com/s/fondamento/v17/4UaHrEJGsxNmFTPDnkaJ96rp5w.woff2"
            }
        }
    }
});
