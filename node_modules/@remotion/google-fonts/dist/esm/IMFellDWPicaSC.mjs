...
const getInfo = () => ({
    ...
    "version": "v21",
    "url": "https://fonts.googleapis.com/css2?family=IM+Fell+DW+Pica+SC:ital,wght@0,400",
    "unicodeRanges": {
    ...
    "fonts": {
        "normal": {
            "400": {
                "latin": "https://fonts.gstatic.com/s/imfelldwpicasc/v21/0ybjGCAu5PfqkvtGVU15aBhXz3EUrnTm_xKL.woff2"
            }
        }
    }
});
