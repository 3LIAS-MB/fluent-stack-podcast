...
const getInfo = () => ({
    ...
    "fonts": {
        "normal": {
            "400": {
                "latin-ext": "https://fonts.gstatic.com/s/average/v18/fC1hPYBHe23MxA7rEet6VFyt.woff2",
                "latin": "https://fonts.gstatic.com/s/average/v18/fC1hPYBHe23MxA7rEeV6VA.woff2"
            }
        }
    }
});
