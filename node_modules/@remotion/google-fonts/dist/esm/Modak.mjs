...
const getInfo = () => ({
    ...
    "fonts": {
        "normal": {
            "400": {
                "devanagari": "https://fonts.gstatic.com/s/modak/v18/EJRYQgs1XtIEskMB-hRp7w.woff2",
                "latin-ext": "https://fonts.gstatic.com/s/modak/v18/EJRYQgs1XtIEskMO-hRp7w.woff2",
                "latin": "https://fonts.gstatic.com/s/modak/v18/EJRYQgs1XtIEskMA-hQ.woff2"
            }
        }
    }
});
