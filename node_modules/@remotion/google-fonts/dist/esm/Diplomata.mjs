...
const getInfo = () => ({
    ...
    "version": "v27",
    "url": "https://fonts.googleapis.com/css2?family=Diplomata:ital,wght@0,400",
    "unicodeRanges": {
    ...
    "fonts": {
        "normal": {
            "400": {
                "latin-ext": "https://fonts.gstatic.com/s/diplomata/v27/Cn-0JtiMXwhNwp-wKxyvaWZZndM.woff2",
                "latin": "https://fonts.gstatic.com/s/diplomata/v27/Cn-0JtiMXwhNwp-wKxyvZ2ZZ.woff2"
            }
        }
    }
});
