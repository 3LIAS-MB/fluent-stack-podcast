...
const getInfo = () => ({
    ...
    "version": "v15",
    "url": "https://fonts.googleapis.com/css2?family=Monsieur+La+Doulaise:ital,wght@0,400",
    "unicodeRanges": {
    ...
    "fonts": {
        "normal": {
            "400": {
                "latin-ext": "https://fonts.gstatic.com/s/monsieurladoulaise/v15/_Xmz-GY4rjmCbQfc-aPRaa4pqV340p7EZm5XyEAk4A.woff2",
                "latin": "https://fonts.gstatic.com/s/monsieurladoulaise/v15/_Xmz-GY4rjmCbQfc-aPRaa4pqV340p7EZm5ZyEA.woff2"
            }
        }
    }
});
