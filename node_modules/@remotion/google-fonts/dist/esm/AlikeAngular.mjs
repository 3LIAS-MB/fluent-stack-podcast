...
const getInfo = () => ({
    ...
    "version": "v20",
    "url": "https://fonts.googleapis.com/css2?family=Alike+Angular:ital,wght@0,400",
    "unicodeRanges": {
    ...
    "fonts": {
        "normal": {
            "400": {
                "latin": "https://fonts.gstatic.com/s/alikeangular/v20/3qTrojWunjGQtEBlIcwMbSoI7kQwbQ.woff2"
            }
        }
    }
});
