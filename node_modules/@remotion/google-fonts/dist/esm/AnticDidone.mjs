...
const getInfo = () => ({
    ...
    "version": "v16",
    "url": "https://fonts.googleapis.com/css2?family=Antic+Didone:ital,wght@0,400",
    "unicodeRanges": {
    ...
    "fonts": {
        "normal": {
            "400": {
                "latin": "https://fonts.gstatic.com/s/anticdidone/v16/RWmPoKKX6u8sp8fIWdnDKqDSroEH.woff2"
            }
        }
    }
});
