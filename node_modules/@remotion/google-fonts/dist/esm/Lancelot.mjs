...
const getInfo = () => ({
    ...
    "fonts": {
        "normal": {
            "400": {
                "latin-ext": "https://fonts.gstatic.com/s/lancelot/v23/J7acnppxBGtQEulG4KYxzp5yGw.woff2",
                "latin": "https://fonts.gstatic.com/s/lancelot/v23/J7acnppxBGtQEulG4KY_zp4.woff2"
            }
        }
    }
});
