...
const getInfo = () => ({
    ...
    "fonts": {
        "normal": {
            "400": {
                "vietnamese": "https://fonts.gstatic.com/s/unicaone/v15/DPEuYwWHyAYGVTSmalsRft3eiEY.woff2",
                "latin-ext": "https://fonts.gstatic.com/s/unicaone/v15/DPEuYwWHyAYGVTSmalsRf93eiEY.woff2",
                "latin": "https://fonts.gstatic.com/s/unicaone/v15/DPEuYwWHyAYGVTSmalsRcd3e.woff2"
            }
        }
    }
});
