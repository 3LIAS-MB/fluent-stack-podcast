...
const getInfo = () => ({
    ...
    "importName": "Capriola",
    "version": "v14",
    "url": "https://fonts.googleapis.com/css2?family=Capriola:ital,wght@0,400",
    "unicodeRanges": {
    ...
    "fonts": {
        "normal": {
            "400": {
                "latin-ext": "https://fonts.gstatic.com/s/capriola/v14/wXKoE3YSppcvo1PDlk_1JeESnA.woff2",
                "latin": "https://fonts.gstatic.com/s/capriola/v14/wXKoE3YSppcvo1PDlk_7JeE.woff2"
            }
        }
    }
});
