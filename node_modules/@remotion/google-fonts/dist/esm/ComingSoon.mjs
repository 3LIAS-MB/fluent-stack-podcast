...
const getInfo = () => ({
    ...
    "version": "v19",
    "url": "https://fonts.googleapis.com/css2?family=Coming+Soon:ital,wght@0,400",
    "unicodeRanges": {
    ...
    "fonts": {
        "normal": {
            "400": {
                "latin": "https://fonts.gstatic.com/s/comingsoon/v19/qWcuB6mzpYL7AJ2VfdQR1t-VWDk.woff2"
            }
        }
    }
});
