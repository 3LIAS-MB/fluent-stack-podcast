...
const getInfo = () => ({
    ...
    "importName": "Solitreo",
    "version": "v2",
    "url": "https://fonts.googleapis.com/css2?family=Solitreo:ital,wght@0,400",
    "unicodeRanges": {
    ...
    "fonts": {
        "normal": {
            "400": {
                "hebrew": "https://fonts.gstatic.com/s/solitreo/v2/r05YGLlS5a9KYsyNO_uswjcdSg.woff2",
                "latin-ext": "https://fonts.gstatic.com/s/solitreo/v2/r05YGLlS5a9KYsyNO_ugwjcdSg.woff2",
                "latin": "https://fonts.gstatic.com/s/solitreo/v2/r05YGLlS5a9KYsyNO_uuwjc.woff2"
            }
        }
    }
});
