...
const getInfo = () => ({
    ...
    "fonts": {
        "normal": {
            "400": {
                "vietnamese": "https://fonts.gstatic.com/s/fuggles/v9/k3kQo8UEJOlD1hpOfdboLnnA.woff2",
                "latin-ext": "https://fonts.gstatic.com/s/fuggles/v9/k3kQo8UEJOlD1hpOfdfoLnnA.woff2",
                "latin": "https://fonts.gstatic.com/s/fuggles/v9/k3kQo8UEJOlD1hpOfdnoLg.woff2"
            }
        }
    }
});
