...
const getInfo = () => ({
    ...
    "version": "v22",
    "url": "https://fonts.googleapis.com/css2?family=Supermercado+One:ital,wght@0,400",
    "unicodeRanges": {
    ...
    "fonts": {
        "normal": {
            "400": {
                "latin": "https://fonts.gstatic.com/s/supermercadoone/v22/OpNXnpQWg8jc_xps_Gi14kVVEXOn20H9MQ.woff2"
            }
        }
    }
});
