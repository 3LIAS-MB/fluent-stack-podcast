...
const getInfo = () => ({
    ...
    "importName": "Offside",
    "version": "v22",
    "url": "https://fonts.googleapis.com/css2?family=Offside:ital,wght@0,400",
    "unicodeRanges": {
    ...
    "fonts": {
        "normal": {
            "400": {
                "latin-ext": "https://fonts.gstatic.com/s/offside/v22/HI_KiYMWKa9QrAykc5joR6-d.woff2",
                "latin": "https://fonts.gstatic.com/s/offside/v22/HI_KiYMWKa9QrAykc5boRw.woff2"
            }
        }
    }
});
