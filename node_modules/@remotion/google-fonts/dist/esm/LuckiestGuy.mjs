...
const getInfo = () => ({
    ...
    "version": "v18",
    "url": "https://fonts.googleapis.com/css2?family=Luckiest+Guy:ital,wght@0,400",
    "unicodeRanges": {
    ...
    "fonts": {
        "normal": {
            "400": {
                "latin": "https://fonts.gstatic.com/s/luckiestguy/v18/_gP_1RrxsjcxVyin9l9n_j2hTd52.woff2"
            }
        }
    }
});
