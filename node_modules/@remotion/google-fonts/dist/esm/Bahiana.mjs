...
const getInfo = () => ({
    ...
    "fonts": {
        "normal": {
            "400": {
                "latin-ext": "https://fonts.gstatic.com/s/bahiana/v19/uU9PCBUV4YenPWJU3xrR38yH.woff2",
                "latin": "https://fonts.gstatic.com/s/bahiana/v19/uU9PCBUV4YenPWJU3xTR3w.woff2"
            }
        }
    }
});
