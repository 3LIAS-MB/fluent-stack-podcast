...
const getInfo = () => ({
    ...
    "importName": "Ranchers",
    "version": "v14",
    "url": "https://fonts.googleapis.com/css2?family=Ranchers:ital,wght@0,400",
    "unicodeRanges": {
    ...
    "fonts": {
        "normal": {
            "400": {
                "latin-ext": "https://fonts.gstatic.com/s/ranchers/v14/zrfm0H3Lx-P2Xvs2ArDRBi_NXQ.woff2",
                "latin": "https://fonts.gstatic.com/s/ranchers/v14/zrfm0H3Lx-P2Xvs2ArDfBi8.woff2"
            }
        }
    }
});
