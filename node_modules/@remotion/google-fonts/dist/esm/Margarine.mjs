...
const getInfo = () => ({
    ...
    "version": "v22",
    "url": "https://fonts.googleapis.com/css2?family=Margarine:ital,wght@0,400",
    "unicodeRanges": {
    ...
    "fonts": {
        "normal": {
            "400": {
                "latin-ext": "https://fonts.gstatic.com/s/margarine/v22/qkBXXvoE6trLT9Y7YLyu7Z5KoAU.woff2",
                "latin": "https://fonts.gstatic.com/s/margarine/v22/qkBXXvoE6trLT9Y7YLyu455K.woff2"
            }
        }
    }
});
