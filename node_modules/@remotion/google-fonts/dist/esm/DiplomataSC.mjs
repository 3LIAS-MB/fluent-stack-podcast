...
const getInfo = () => ({
    ...
    "version": "v23",
    "url": "https://fonts.googleapis.com/css2?family=Diplomata+SC:ital,wght@0,400",
    "unicodeRanges": {
    ...
    "fonts": {
        "normal": {
            "400": {
                "latin-ext": "https://fonts.gstatic.com/s/diplomatasc/v23/buExpoi3ecvs3kidKgBJo2kv8fRPWiw.woff2",
                "latin": "https://fonts.gstatic.com/s/diplomatasc/v23/buExpoi3ecvs3kidKgBJo2kv__RP.woff2"
            }
        }
    }
});
