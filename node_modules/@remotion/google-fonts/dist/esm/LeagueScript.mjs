...
const getInfo = () => ({
    ...
    "version": "v24",
    "url": "https://fonts.googleapis.com/css2?family=League+Script:ital,wght@0,400",
    "unicodeRanges": {
    ...
    "fonts": {
        "normal": {
            "400": {
                "latin": "https://fonts.gstatic.com/s/leaguescript/v24/CSR54zpSlumSWj9CGVsoBZdeWNReuQ.woff2"
            }
        }
    }
});
