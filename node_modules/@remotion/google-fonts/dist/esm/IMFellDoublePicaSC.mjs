...
const getInfo = () => ({
    ...
    "version": "v21",
    "url": "https://fonts.googleapis.com/css2?family=IM+Fell+Double+Pica+SC:ital,wght@0,400",
    "unicodeRanges": {
    ...
    "fonts": {
        "normal": {
            "400": {
                "latin": "https://fonts.gstatic.com/s/imfelldoublepicasc/v21/neIazDmuiMkFo6zj_sHpQ8teNbWlwBB_hXjJ0YoOew.woff2"
            }
        }
    }
});
