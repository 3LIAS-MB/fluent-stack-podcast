...
const getInfo = () => ({
    ...
    "fonts": {
        "normal": {
            "400": {
                "latin-ext": "https://fonts.gstatic.com/s/trykker/v21/KtktALyWZJXudUPztNDiOO2j.woff2",
                "latin": "https://fonts.gstatic.com/s/trykker/v21/KtktALyWZJXudUPztN7iOA.woff2"
            }
        }
    }
});
