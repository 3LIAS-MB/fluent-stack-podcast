...
const getInfo = () => ({
    ...
    "fonts": {
        "italic": {
            "400": {
                "latin": "https://fonts.gstatic.com/s/imfelldwpica/v16/2sDEZGRQotv9nbn2qSl0TxXVYNwNZjnXlis.woff2"
            }
        },
        "normal": {
            "400": {
                "latin": "https://fonts.gstatic.com/s/imfelldwpica/v16/2sDGZGRQotv9nbn2qSl0TxXVYNwNYwnV.woff2"
            }
        }
    }
});
