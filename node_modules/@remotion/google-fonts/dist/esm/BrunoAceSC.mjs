...
const getInfo = () => ({
    ...
    "version": "v1",
    "url": "https://fonts.googleapis.com/css2?family=Bruno+Ace+SC:ital,wght@0,400",
    "unicodeRanges": {
    ...
    "fonts": {
        "normal": {
            "400": {
                "latin-ext": "https://fonts.gstatic.com/s/brunoacesc/v1/ptROTiycffFLBuiHjdJDl63IJCtqle8.woff2",
                "latin": "https://fonts.gstatic.com/s/brunoacesc/v1/ptROTiycffFLBuiHjdJDl63IKitq.woff2"
            }
        }
    }
});
