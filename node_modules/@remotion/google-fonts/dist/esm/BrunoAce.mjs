...
const getInfo = () => ({
    ...
    "importName": "BrunoAce",
    "version": "v1",
    "url": "https://fonts.googleapis.com/css2?family=Bruno+Ace:ital,wght@0,400",
    "unicodeRanges": {
    ...
    "fonts": {
        "normal": {
            "400": {
                "latin-ext": "https://fonts.gstatic.com/s/brunoace/v1/WwkcxPa2E06x4trkOj_UOaANaNM.woff2",
                "latin": "https://fonts.gstatic.com/s/brunoace/v1/WwkcxPa2E06x4trkOj_UN6AN.woff2"
            }
        }
    }
});
