...
const getInfo = () => ({
    ...
    "version": "v15",
    "url": "https://fonts.googleapis.com/css2?family=Cutive+Mono:ital,wght@0,400",
    "unicodeRanges": {
    ...
    "fonts": {
        "normal": {
            "400": {
                "latin-ext": "https://fonts.gstatic.com/s/cutivemono/v15/m8JWjfRfY7WVjVi2E-K9H6RMTm663A.woff2",
                "latin": "https://fonts.gstatic.com/s/cutivemono/v15/m8JWjfRfY7WVjVi2E-K9H6RCTm4.woff2"
            }
        }
    }
});
