...
const getInfo = () => ({
    ...
    "fonts": {
        "normal": {
            "400": {
                "lepcha": "https://fonts.gstatic.com/s/mingzat/v6/0QIgMX5C-o-oWWyvNuRumsmv.woff2",
                "latin-ext": "https://fonts.gstatic.com/s/mingzat/v6/0QIgMX5C-o-oWWyvNtJumsmv.woff2",
                "latin": "https://fonts.gstatic.com/s/mingzat/v6/0QIgMX5C-o-oWWyvNtxumg.woff2"
            }
        }
    }
});
