...
const getInfo = () => ({
    ...
    "fonts": {
        "normal": {
            "400": {
                "latin-ext": "https://fonts.gstatic.com/s/princesssofia/v22/qWczB6yguIb8DZ_GXZst16n7GSzykjQYug.woff2",
                "latin": "https://fonts.gstatic.com/s/princesssofia/v22/qWczB6yguIb8DZ_GXZst16n7GSz8kjQ.woff2"
            }
        }
    }
});
