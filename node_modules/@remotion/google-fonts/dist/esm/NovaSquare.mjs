...
const getInfo = () => ({
    ...
    "version": "v20",
    "url": "https://fonts.googleapis.com/css2?family=Nova+Square:ital,wght@0,400",
    "unicodeRanges": {
    ...
    "fonts": {
        "normal": {
            "400": {
                "latin": "https://fonts.gstatic.com/s/novasquare/v20/RrQUbo9-9DV7b06QHgSWsahHT4I.woff2"
            }
        }
    }
});
