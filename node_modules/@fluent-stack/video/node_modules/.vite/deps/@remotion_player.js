...
import {
  ...
  interpolate,
  random
} from "./chunk-T6LPPPEL.js";
import "./chunk-KZFJTF3O.js";
import {
  require_jsx_runtime
...
var useHoverState = (ref) => {
  const [hovered, stetHovered] = (0, import_react.useState)(false);
...
var usePlayer = () => {
  ...
  const { audioAndVideoTags } = (0, import_react.useContext)(Internals.Timeline.TimelineContext);
...
var usePlayback = ({ loop, playbackRate, moveToBeginningWhenEnded, inFrame, outFrame }) => {
  const config = Internals.useUnsafeVideoConfig();
  const frame = Internals.Timeline.useTimelinePosition();
  ...
  frameRef.current = frame;
  const lastTimeUpdateEvent = (0, import_react.useRef)(null);
  (0, import_react.useEffect)(() => {
    if (!config) {
      return;
    }
...
var ErrorBoundary = class extends import_react.default.Component {
  ...
  render() {
    if (this.state.hasError) {
      return (0, import_jsx_runtime.jsx)("div", { style: errorStyle, children: this.props.errorFallback({
...
var PlayIcon = () => {
  return (0, import_jsx_runtime.jsx)("svg", { width: ICON_SIZE, height: ICON_SIZE, viewBox: "-100 -100 400 400", style: rotate, children: (0, import_jsx_runtime.jsx)("path", { fill: "#fff", stroke: "#fff", strokeWidth: "100", strokeLinejoin: "round", d: "M 2 172 a 196 100 0 0 0 195 5 A 196 240 0 0 0 100 2.259 A 196 240 0 0 0 2 172 z" }) });
};
var PauseIcon = () => {
  return (0, import_jsx_runtime.jsxs)("svg", { viewBox: "0 0 100 100", width: ICON_SIZE, height: ICON_SIZE, children: [(0, import_jsx_runtime.jsx)("rect", { x: "25", y: "20", width: "20", height: "60", fill: "#fff", ry: "5", rx: "5" }), (0, import_jsx_runtime.jsx)("rect", { x: "55", y: "20", width: "20", height: "60", fill: "#fff", ry: "5", rx: "5" })] });
};
var FullscreenIcon = ({ isFullscreen }) => {
  ...
  return (0, import_jsx_runtime.jsxs)("svg", { viewBox: `0 0 ${viewSize} ${viewSize}`, height: fullscreenIconSize, width: fullscreenIconSize, children: [(0, import_jsx_runtime.jsx)("path", { d: `
				M ${out} ${inset}
				L ${middleInset} ${middleInset}
				L ${inset} ${out}
				`, stroke: "#fff", strokeWidth, fill: "none" }), (0, import_jsx_runtime.jsx)("path", { d: `
...
var MediaVolumeSlider = ({ displayVerticalVolumeSlider }) => {
  ...
  const randomId = (
    ...
    typeof import_react.default.useId === "undefined" ? "volume-slider" : import_react.default.useId()
  );
...
var PlaybackPopup = ({ setIsComponentVisible, playbackRates, canvasSize }) => {
  ...
  const playbackPopup = (0, import_react.useMemo)(() => {
    return {
      position: "absolute",
      right: 0,
      width: 125,
  ...
  return (0, import_jsx_runtime.jsx)("div", { style: playbackPopup, children: playbackRates.map((rate) => {
    return (0, import_jsx_runtime.jsx)(PlaybackrateOption, { selectedRate: playbackRate, onSelect, rate, keyboardSelectedRate }, rate);
  }) });
};
var PlaybackrateOption = ({ rate, onSelect, selectedRate, keyboardSelectedRate }) => {
  ...
  return (0, import_jsx_runtime.jsxs)("div", { onMouseEnter, onMouseLeave, tabIndex: 0, style: actualStyle, onClick, children: [(0, import_jsx_runtime.jsx)("div", { style: checkmarkContainer, children: rate === selectedRate ? (0, import_jsx_runtime.jsx)(Checkmark, {}) : null }), rate.toFixed(1), "x"] }, rate);
};
var label = {
  fontSize: 13,
  fontWeight: "bold",
...
var PlaybackrateControl = ({ playbackRates, canvasSize }) => {
  ...
  const { playbackRate } = (0, import_react.useContext)(Internals.Timeline.TimelineContext);
  const onClick = (0, import_react.useCallback)((e) => {
    e.stopPropagation();
    e.preventDefault();
    setIsComponentVisible(!isComponentVisible);
  }, [isComponentVisible, setIsComponentVisible]);
  return (0, import_jsx_runtime.jsx)("div", { ref, children: (0, import_jsx_runtime.jsxs)("button", { type: "button", "aria-label": "Change playback rate", style: button, onClick, children: [(0, import_jsx_runtime.jsxs)("div", { style: label, children: [playbackRate, "x"] }), isComponentVisible && (0, import_jsx_runtime.jsx)(PlaybackPopup, { canvasSize, playbackRates, setIsComponentVisible })] }) });
};
...
var PlayerSeekBar = ({ durationInFrames, onSeekEnd, onSeekStart, inFrame, outFrame }) => {
  ...
  const knobStyle = (0, import_react.useMemo)(() => {
    ...
    return {
      ...
      left: Math.max(0, frame / Math.max(1, durationInFrames - 1) * ((_a = size === null || size === void 0 ? void 0 : size.width) !== null && _a !== void 0 ? _a : 0) - KNOB_SIZE / 2),
  ...
  return (0, import_jsx_runtime.jsxs)("div", { ref: containerRef, onPointerDown, style: containerStyle$1, children: [(0, import_jsx_runtime.jsxs)("div", { style: barBackground, children: [(0, import_jsx_runtime.jsx)("div", { style: active }), (0, import_jsx_runtime.jsx)("div", { style: fillStyle })] }), (0, import_jsx_runtime.jsx)("div", { style: knobStyle })] });
};
var X_SPACER = 10;
var X_PADDING = 12;
var useVideoControlsResize = ({ allowFullscreen: allowFullScreen, playerWidth }) => {
  const resizeInfo = (0, import_react.useMemo)(() => {
...
var Controls = ({ durationInFrames, hovered, isFullscreen, fps, player, showVolumeControls, onFullscreenButtonClick, allowFullscreen, onExitFullscreenButtonClick, spaceKeyToPlayOrPause, onSeekEnd, onSeekStart, inFrame, outFrame, initiallyShowControls, canvasSize, renderPlayPauseButton, renderFullscreenButton, alwaysShowControls, showPlaybackRateControl }) => {
  ...
  const timeLabel = (0, import_react.useMemo)(() => {
    return {
      color: "white",
  ...
  return (0, import_jsx_runtime.jsxs)("div", { style: containerCss, children: [(0, import_jsx_runtime.jsxs)("div", { style: controlsRow, children: [(0, import_jsx_runtime.jsxs)("div", { style: leftPartStyle, children: [(0, import_jsx_runtime.jsx)("button", { ref: playButtonRef, type: "button", style: playerButtonStyle, onClick: player.playing ? player.pause : player.play, "aria-label": player.playing ? "Pause video" : "Play video", title: player.playing ? "Pause video" : "Play video", children: renderPlayPauseButton === null ? (0, import_jsx_runtime.jsx)(PlayPauseButton, { playing: player.playing }) : renderPlayPauseButton({ playing: player.playing }) }), showVolumeControls ? (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [(0, import_jsx_runtime.jsx)("div", { style: xSpacer }), (0, import_jsx_runtime.jsx)(MediaVolumeSlider, { displayVerticalVolumeSlider })] }) : null, (0, import_jsx_runtime.jsx)("div", { style: xSpacer }), (0, import_jsx_runtime.jsxs)("div", { style: timeLabel, children: [formatTime(frame / fps), " / ", formatTime(durationInFrames / fps)] }), (0, import_jsx_runtime.jsx)("div", { style: xSpacer })] }), (0, import_jsx_runtime.jsx)("div", { style: flex1 }), playbackRates && canvasSize && (0, import_jsx_runtime.jsx)(PlaybackrateControl, { canvasSize, playbackRates }), playbackRates && supportsFullscreen && allowFullscreen ? (0, import_jsx_runtime.jsx)("div", { style: xSpacer }) : null, (0, import_jsx_runtime.jsx)("div", { style: fullscreen, children: supportsFullscreen && allowFullscreen ? (0, import_jsx_runtime.jsx)("button", { type: "button", "aria-label": isFullscreen ? "Exit fullscreen" : "Enter Fullscreen", title: isFullscreen ? "Exit fullscreen" : "Enter Fullscreen", style: playerButtonStyle, onClick: isFullscreen ? onExitFullscreenButtonClick : onFullscreenButtonClick, children: renderFullscreenButton === null ? (0, import_jsx_runtime.jsx)(FullscreenIcon, { isFullscreen }) : renderFullscreenButton({ isFullscreen }) }) : null })] }), (0, import_jsx_runtime.jsx)("div", { style: ySpacer }), (0, import_jsx_runtime.jsx)(PlayerSeekBar, { onSeekEnd, onSeekStart, durationInFrames, inFrame, outFrame })] });
};
...
var reactVersion$1 = import_react.default.version.split(".")[0];
if (reactVersion$1 === "0") {
...
var PlayerUI = ({ controls, style, loop, autoPlay, allowFullscreen, inputProps, clickToPlay, showVolumeControls, doubleClickToFullscreen, spaceKeyToPlayOrPause, errorFallback, playbackRate, renderLoading, renderPoster, className, moveToBeginningWhenEnded, showPosterWhenUnplayed, showPosterWhenEnded, showPosterWhenPaused, inFrame, outFrame, initiallyShowControls, renderFullscreen: renderFullscreenButton, renderPlayPauseButton, alwaysShowControls, showPlaybackRateControl }, ref) => {
  var _a, _b, _c;
  const config = Internals.useUnsafeVideoConfig();
  const video = Internals.useVideo();
  ...
  const { setMediaVolume, setMediaMuted } = (0, import_react.useContext)(Internals.SetMediaVolumeContext);
  const { mediaMuted, mediaVolume } = (0, import_react.useContext)(Internals.MediaVolumeContext);
  (0, import_react.useEffect)(() => {
  ...
  const containerStyle2 = (0, import_react.useMemo)(() => {
  ...
  const content = (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [(0, import_jsx_runtime.jsx)("div", { style: outer, onClick: clickToPlay ? handleClick : void 0, onDoubleClick: doubleClickToFullscreen ? handleDoubleClick : void 0, children: (0, import_jsx_runtime.jsx)("div", { style: containerStyle2, className: PLAYER_CSS_CLASSNAME, children: VideoComponent ? (0, import_jsx_runtime.jsx)(ErrorBoundary, { onError, errorFallback, children: (0, import_jsx_runtime.jsx)(VideoComponent, { ...(_c = video === null || video === void 0 ? void 0 : video.props) !== null && _c !== void 0 ? _c : {}, ...inputProps !== null && inputProps !== void 0 ? inputProps : {} }) }) : null }) }), shouldShowPoster ? (0, import_jsx_runtime.jsx)("div", { style: outer, onClick: clickToPlay ? handleClick : void 0, onDoubleClick: doubleClickToFullscreen ? handleDoubleClick : void 0, children: poster }) : null, controls ? (0, import_jsx_runtime.jsx)(Controls, { fps: config.fps, durationInFrames: config.durationInFrames, hovered, player, onFullscreenButtonClick, isFullscreen, allowFullscreen, showVolumeControls, onExitFullscreenButtonClick, spaceKeyToPlayOrPause, onSeekEnd, onSeekStart, inFrame, outFrame, initiallyShowControls, canvasSize, renderFullscreenButton, renderPlayPauseButton, alwaysShowControls, showPlaybackRateControl }) : null] });
  if (IS_NODE && !doesReactVersionSupportSuspense$1) {
    return (0, import_jsx_runtime.jsx)("div", { ref: container, style: outerStyle, className, children: content });
  }
  return (0, import_jsx_runtime.jsx)("div", { ref: container, style: outerStyle, className, children: (0, import_jsx_runtime.jsx)(import_react.Suspense, { fallback: loadingMarkup, children: content }) });
};
var PlayerUI$1 = (0, import_react.forwardRef)(PlayerUI);
...
var SharedPlayerContexts = ({ children, timelineContext, inputProps, fps, compositionHeight, compositionWidth, durationInFrames, component, numberOfSharedAudioTags, initiallyMuted }) => {
  ...
  const [mediaMuted, setMediaMuted] = (0, import_react.useState)(() => initiallyMuted);
  const [mediaVolume, setMediaVolume] = (0, import_react.useState)(() => getPreferredVolume());
  ...
  return (0, import_jsx_runtime.jsx)(Internals.CanUseRemotionHooksProvider, { children: (0, import_jsx_runtime.jsx)(Internals.Timeline.TimelineContext.Provider, { value: timelineContext, children: (0, import_jsx_runtime.jsx)(Internals.CompositionManager.Provider, { value: compositionManagerContext, children: (0, import_jsx_runtime.jsx)(Internals.ResolveCompositionConfig, { children: (0, import_jsx_runtime.jsx)(Internals.PrefetchProvider, { children: (0, import_jsx_runtime.jsx)(Internals.DurationsContextProvider, { children: (0, import_jsx_runtime.jsx)(Internals.MediaVolumeContext.Provider, { value: mediaVolumeContextValue, children: (0, import_jsx_runtime.jsx)(Internals.SetMediaVolumeContext.Provider, { value: setMediaVolumeContextValue, children: (0, import_jsx_runtime.jsx)(Internals.SharedAudioContextProvider, { numberOfAudioTags: numberOfSharedAudioTags, component, children }) }) }) }) }) }) }) }) });
};
...
var PlayerFn = ({ durationInFrames, compositionHeight, compositionWidth, fps, inputProps, style, controls = false, loop = false, autoPlay = false, showVolumeControls = true, allowFullscreen = true, clickToPlay, doubleClickToFullscreen = false, spaceKeyToPlayOrPause = true, moveToBeginningWhenEnded = true, numberOfSharedAudioTags = 5, errorFallback = () => "⚠️", playbackRate = 1, renderLoading, className, showPosterWhenUnplayed, showPosterWhenEnded, showPosterWhenPaused, initialFrame, renderPoster, inFrame, outFrame, initiallyShowControls, renderFullscreenButton, renderPlayPauseButton, alwaysShowControls = false, initiallyMuted = false, showPlaybackRateControl = false, ...componentProps }, ref) => {
  ...
  const actualInputProps = (0, import_react.useMemo)(() => inputProps !== null && inputProps !== void 0 ? inputProps : {}, [inputProps]);
  return (0, import_jsx_runtime.jsx)(Internals.IsPlayerContextProvider, { children: (0, import_jsx_runtime.jsx)(SharedPlayerContexts, { timelineContext: timelineContextValue, component, compositionHeight, compositionWidth, durationInFrames, fps, inputProps: actualInputProps, numberOfSharedAudioTags, initiallyMuted, children: (0, import_jsx_runtime.jsx)(Internals.Timeline.SetTimelineContext.Provider, { value: setTimelineContextValue, children: (0, import_jsx_runtime.jsx)(PlayerEventEmitterContext.Provider, { value: emitter, children: (0, import_jsx_runtime.jsx)(PlayerUI$1, { ref: rootRef, renderLoading, autoPlay: Boolean(autoPlay), loop: Boolean(loop), controls: Boolean(controls), errorFallback, style, inputProps: passedInputProps, allowFullscreen: Boolean(allowFullscreen), moveToBeginningWhenEnded: Boolean(moveToBeginningWhenEnded), clickToPlay: typeof clickToPlay === "boolean" ? clickToPlay : Boolean(controls), showVolumeControls: Boolean(showVolumeControls), doubleClickToFullscreen: Boolean(doubleClickToFullscreen), spaceKeyToPlayOrPause: Boolean(spaceKeyToPlayOrPause), playbackRate: currentPlaybackRate, className: className !== null && className !== void 0 ? className : void 0, showPosterWhenUnplayed: Boolean(showPosterWhenUnplayed), showPosterWhenEnded: Boolean(showPosterWhenEnded), showPosterWhenPaused: Boolean(showPosterWhenPaused), renderPoster, inFrame: inFrame !== null && inFrame !== void 0 ? inFrame : null, outFrame: outFrame !== null && outFrame !== void 0 ? outFrame : null, initiallyShowControls: initiallyShowControls !== null && initiallyShowControls !== void 0 ? initiallyShowControls : true, renderFullscreen: renderFullscreenButton !== null && renderFullscreenButton !== void 0 ? renderFullscreenButton : null, renderPlayPauseButton: renderPlayPauseButton !== null && renderPlayPauseButton !== void 0 ? renderPlayPauseButton : null, alwaysShowControls, showPlaybackRateControl }) }) }) }) });
};
var forward$1 = import_react.forwardRef;
...
var reactVersion = import_react.default.version.split(".")[0];
if (reactVersion === "0") {
  throw new Error(`Version ${reactVersion} of "react" is not supported by Remotion`);
}
var doesReactVersionSupportSuspense = parseInt(reactVersion, 10) >= 18;
var ThumbnailUI = ({ style, inputProps, errorFallback, renderLoading, className }, ref) => {
  var _a, _b;
  const config = Internals.useUnsafeVideoConfig();
  const video = Internals.useVideo();
  const container = (0, import_react.useRef)(null);
  ...
  const content = (0, import_jsx_runtime.jsx)("div", { style: outer, children: (0, import_jsx_runtime.jsx)("div", { style: containerStyle2, className: PLAYER_CSS_CLASSNAME, children: VideoComponent ? (0, import_jsx_runtime.jsx)(ErrorBoundary, { onError, errorFallback, children: (0, import_jsx_runtime.jsx)(VideoComponent, { ...(_b = video === null || video === void 0 ? void 0 : video.props) !== null && _b !== void 0 ? _b : {}, ...inputProps !== null && inputProps !== void 0 ? inputProps : {} }) }) : null }) });
  if (IS_NODE && !doesReactVersionSupportSuspense) {
    return (0, import_jsx_runtime.jsx)("div", { ref: container, style: outerStyle, className, children: content });
  }
  return (0, import_jsx_runtime.jsx)("div", { ref: container, style: outerStyle, className, children: (0, import_jsx_runtime.jsx)(import_react.Suspense, { fallback: loadingMarkup, children: content }) });
};
var ThumbnailUI$1 = (0, import_react.forwardRef)(ThumbnailUI);
var ThumbnailFn = ({ frameToDisplay, style, inputProps, compositionHeight, compositionWidth, durationInFrames, fps, className, errorFallback = () => "⚠️", renderLoading, ...componentProps }, ref) => {
  ...
  return (0, import_jsx_runtime.jsx)(Internals.IsPlayerContextProvider, { children: (0, import_jsx_runtime.jsx)(SharedPlayerContexts, { timelineContext: timelineState, component: Component, compositionHeight, compositionWidth, durationInFrames, fps, inputProps: passedInputProps, numberOfSharedAudioTags: 0, initiallyMuted: true, children: (0, import_jsx_runtime.jsx)(ThumbnailEmitterContext.Provider, { value: emitter, children: (0, import_jsx_runtime.jsx)(ThumbnailUI$1, { className, errorFallback, inputProps: passedInputProps, renderLoading, style }) }) }) });
};
var forward = import_react.forwardRef;
